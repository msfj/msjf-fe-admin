...
class UpdateForm extends PureComponent {
  ...
  constructor(props) {
    ...
    this.state = {
      formVals: {
        ...
        enterpriseClass: props.enterpriseClass,
        enterpriseType: props.enterpriseType,
        account: props.values.account,
        certificateType: props.values.certificateType,
  ...
  renderContent = (currentStep, formVals) => {
    ...
    return [
      ...
      <FormItem key="userType" {...this.formLayout} label="用户类型">
        {form.getFieldDecorator('userType', {
          rules: [{ required: true, message: '请输入至少五个字符的规则描述！', min: 5 }],
          initialValue: formVals.userType,
